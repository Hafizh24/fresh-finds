...
export const ModalUserCreateAddress = ({ modalAddOpen, handleModalAddOpen, fetchUserAddressData, fetchAllAddress, currentPage }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post('customer-address/create', dataToSend, {
        headers: {
    ...
    <Dialog Dialog size="lg" open={modalAddOpen} handler={() => handleModalAddOpen()} className="flex flex-col items-center">
      ...
      <DialogBody className="flex flex-col gap-4 items-center w-full px-4 md:px-10">
        <form onSubmit={formik.handleSubmit} className="w-full">
          {/* 1 */}
          <section id="modal-scroll" className={`${activeStep == 0 ? 'block' : 'hidden'} w-full h-[52vh] lg:h-[50vh] overflow-auto pb-2 pr-3 lg:pr-0 lg:pb-0`}>
              ...
              <div className="flex flex-col w-full gap-3.5">
                <div className="w-full">
                  ...
                  <input
                    ...
                    autoComplete="off"
                  />
                  {formik.touched.title && formik.errors.title ? <span className="pl-[0.1rem] pb-1 text-red-500 text-[14px]">{formik.errors.title}</span> : null}
                </div>
                <div className="w-full">
                  ...
                  {formik.touched.customerAddressName && formik.errors.customerAddressName ? (
                    <span className="pl-[0.1rem] pb-1 text-red-500 text-[14px]">{formik.errors.customerAddressName}</span>
                  ) : null}
                </div>
              </div>
              ...
              <div className="flex flex-col w-full gap-3.5">
                <div className="w-full">
                  ...
                  {formik.touched.phoneNumber && formik.errors.phoneNumber ? (
                    <span className="pl-[0.1rem] pb-1 text-red-500 text-[14px]">{formik.errors.phoneNumber}</span>
                  ) : null}
                </div>
              </div>
            </div>
