...
export const ModalError = ({ modalErrorOpen, setModalErrorOpen }) => {
  return (
    <Dialog size="sm" open={modalErrorOpen} className="px-3 pb-3 pt-5 flex flex-col items-center">
      <DialogBody className="flex flex-col gap-4 items-center">
        <div className="flex items-center justify-center p-7 rounded-full bg-[#FEF9C3]">
        ...
        <h3 className="text-[24px] text-[#28302A] font-bold text-center">Email is Already Registered!</h3>
        <span className="text-[15px] text-gray-6s00 w-[90%] text-center font-normal">please use another email for registration</span>
      </DialogBody>
...
ModalError.propTypes = {
  modalErrorOpen: PropTypes.bool.isRequired,
  setModalErrorOpen: PropTypes.func.isRequired
}
